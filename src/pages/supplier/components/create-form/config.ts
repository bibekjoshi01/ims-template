...
export const supplierCreateFormSchema = z.object({
...
export type TSupplierCreateFormDataType = z.infer<typeof supplierCreateFormSchema>;

export const defaultValues: TSupplierCreateFormDataType = {
  name: '',
  contactPerson: '',
  email: '',
  phoneNo: '',
...
export const supplierInfoFields: FormField<TSupplierCreateFormDataType>[] = [
